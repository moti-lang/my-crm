...
const GUARD = { 'wa-webhook': 'verifyHubSignature', 'ai-answer': 'requireUserJwt', 'ai-command': 'requireUserJwt', 'sumit-webhook': 'requireSharedSecret', 'sumit-checkout': 'requirePayToken', 'enroll': 'requireEnrollBody' };
